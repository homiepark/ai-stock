...
| **🆕 인터랙티브 대시보드 (Vercel)** | [docs/VERCEL_SETUP.md](docs/VERCEL_SETUP.md) — Next.js + Vercel 배포 (검색·필터·정렬·디테일 페이지) |
| **🔥 "지금 사도 되나" 판단** | [docs/OVERHEAT_GUIDE.md](docs/OVERHEAT_GUIDE.md) — 과열도 + 라벨 매트릭스 매수 결정표 |
| **GitHub Pages (정적, 레거시)** | [docs/SITE_SETUP.md](docs/SITE_SETUP.md) — GitHub Pages + 자동 배포 |
